...
# 管理者データの作成
puts "👑 管理者データを作成中..."
admin = Admin.find_or_create_by!(user_login_name: "admin_test") do |a|
  a.name = "テスト管理者"
...
puts "✅ 管理者データ作成完了: #{admin.name} (ログイン名: #{admin.user_login_name})"
...
puts "  - #{student1.name} (生徒番号: #{student1.student_number}, 校舎: #{student1.campus_name})"
puts "  - #{student2.name} (生徒番号: #{student2.student_number}, 校舎: #{student2.campus_name})"
puts "  - #{student3.name} (生徒番号: #{student3.student_number}, 校舎: #{student3.campus_name})"
